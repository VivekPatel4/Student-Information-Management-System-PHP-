<?php
    ...
    $query -> execute();
    $msg="The selected remainder has been deleted";
                    ...
                    <div class="col-12 mt-5">
                        ...
                        <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                            ...
                            <div class="card-body">
                                ...
                                <center><a href="add-remainder.php" class="btn btn-sm btn-info">Add New remainder</a></center>
                                    ...
                                    {               ?>  
                                        <tr>
                                            ...
                                            <td><?php echo htmlentities($result->wishyear);?></td>
                                            <td><a href="remainder.php?del=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you want to delete');"> <i class="fa fa-trash" style="color:red"></i></a></td>
                                        </tr>
                                         <?php $cnt++;} }?>
                                    </tbody>
                                    </table>
