                    ...
                    <div class="col-12 mt-5">
                        ...
                        <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                            ...
                            <div class="card-body">
                                ...
                                <center><a href="add-employee.php" class="btn btn-sm btn-info">Add New Student</a></center>
                                 
                                <a href="birth.php" class="btn btn-sm btn-info">BirthDay List</a>
                                    ...
                                    <?php 
                                    $sql = "SELECT photo, RoomNo,EmpId,FirstName,LastName,Department,Status,RegDate,id from  tblemployees";
                                    $query = $dbh -> prepare($sql);
                                    $query->execute();
                                    ...
                                    {               ?>  
                                        <tr>
                                            ...
                                            <td><a href="update-employee.php?empid=<?php echo htmlentities($result->id);?>"><i class="fa fa-edit" style="color:green"></i></a><a href="employees.php?del=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you want to delete');"> <i class="fa fa-trash" style="color:red"></i></a>
                                        ...
                                        <?php } else {?>
                                            ...
                                            <?php } ?> 
                                            <a href="view-student-details.php?studentid=<?php echo htmlentities($result->id);?>">
