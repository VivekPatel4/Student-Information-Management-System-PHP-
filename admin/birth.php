                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Student Birthday List</h4>
                            <ul class="breadcrumbs pull-left">
                                <li><a href="employees.php">Home</a></li>
                                <li><span>Student Birthday List</span></li>
                        ...
                        <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                            ...
                            <div class="card-body">
                                <div class="data-tables datatable-dark">
                                    ...
                                    $currentDate = date("m-d"); // Get the current date in the format "MM-DD"
                                    $sql = "SELECT * FROM tblemployees WHERE DATE_FORMAT(dob ,'%m-%d') = '$currentDate'";
