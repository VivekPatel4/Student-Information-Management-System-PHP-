                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Today Return In Hostel</h4>
                            <ul class="breadcrumbs pull-left">
                                <li><a href="dashboard.php">Home</a></li>
                                <li><span>Today Return Students</span></li>
                                ...
                                <div class="col-12 mt-5">
                                    <div class="card">
                                        ...
                                        <div class="single-table">
                                           ...
                                           $sql = "SELECT tblleaves.id as lid, tblemployees.photo, tblemployees.FirstName, tblemployees.LastName, tblemployees.EmpId, tblemployees.id, tblleaves.LeaveType, tblleaves.PostingDate, tblleaves.Status FROM tblleaves JOIN tblemployees ON tblleaves.empid = tblemployees.id WHERE tblleaves.Status = :status AND ToDate = :currentdate ORDER BY lid DESC";
