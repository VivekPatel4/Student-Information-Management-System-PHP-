            ...
            <div class="main-content-inner">
                ...
                <div class="row">
                        <div class="col-md-4">
                            <div class="single-report mb-xs-30">
                                <div class="s-report-inner pr--20 pt--30 mb-3">
                                    <div class="icon"><a href="present.php"><i class="fa fa-child"></i></a></div>
                                    <div class="s-report-title d-flex justify-content-between">
                                        <h4 class="header-title mb-0">Present student</h4>
                                        
                                    </div>
                                    <div class="d-flex justify-content-between pb-2">
                                        <h1><?php include 'counters/a1.php'?></h1>
                                        <span>Hostel in student</span>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="single-report mb-xs-30">
                                <div class="s-report-inner pr--20 pt--30 mb-3">
                                    <div class="icon"><a href="absent.php"><i class="ti-home"></i></a></div>
                                    <div class="s-report-title d-flex justify-content-between">
                                        <h4 class="header-title mb-0">Absent student</h4>
                                        
                                    </div>
                                    <div class="d-flex justify-content-between pb-2">
                                        <h1><?php include 'counters/p1.php'?></h1>
                        ...
                        <div class="col-md-4">
                            <div class="single-report mb-xs-30">
                                <div class="s-report-inner pr--20 pt--30 mb-3">
                                    <div class="icon"><a href="today hostel.php"><i class="fa fa-hotel"></i></a></div>
                                    <div class="s-report-title d-flex justify-content-between">
                                        <h4 class="header-title mb-0"> Today Return In Hostel</h4>
                                        
                                    </div>
                                    <div class="d-flex justify-content-between pb-2">
                                        <h1><?php include 'counters/today.php'?></h1>
                                        <span>Today Return Students</span>
                                    </div>
                                </div>
                                <!-- <canvas id="coin_sales1" height="100"></canvas> -->
                            </div>
                ...
                <br>
                    <div class="row">
                        <div class="col-md-4">
                            <div class="single-report mb-xs-30">
                                <div class="s-report-inner pr--20 pt--30 mb-3">
                                    <div class="icon"><a href="leave-section.php"><i class="fa fa-briefcase"></a></i></div>
                                    <div class="s-report-title d-flex justify-content-between">
                        ...
                        <div class="col-md-4">
                            <div class="single-report mb-xs-30">
                                <div class="s-report-inner pr--20 pt--30 mb-3">
                                    <div class="icon"><a href="employees.php"><i class="fa fa-users"></i></a></div>
                                    <div class="s-report-title d-flex justify-content-between">
                        ...
                        <div class="col-md-4">
                            <div class="single-report">
                                <div class="s-report-inner pr--20 pt--30 mb-3">
                                    <div class="icon"><a href="department.php"><i class="fa fa-th-large"></i></a></div>
                                    <div class="s-report-title d-flex justify-content-between">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="single-report mb-xs-30">
                                <div class="s-report-inner pr--20 pt--30 mb-3">
                                    <div class="icon"><a href="pending-history.php"><i class="fa fa-spinner"></i></a></div>
                                    <div class="s-report-title d-flex justify-content-between">
                        ...
                        <div class="col-md-4">
                            <div class="single-report mb-xs-30">
                                <div class="s-report-inner pr--20 pt--30 mb-3">
                                    <div class="icon"><a href="declined-history.php"><i class="fa fa-times"></i></a></div>
                                    <div class="s-report-title d-flex justify-content-between">
                        ...
                        <div class="col-md-4">
                            <div class="single-report">
                                <div class="s-report-inner pr--20 pt--30 mb-3">
                                    <div class="icon"><a href="approved-history.php"><i class="fa fa-check-square-o"></i></a></div>
                                    <div class="s-report-title d-flex justify-content-between">
                                        ...
                                        <div class="single-table">
                                            <div class="table-responsive">
                                                ...
                                                <?php 
                                                    ...
                                                    $sql = "SELECT tblleaves.id as lid,tblemployees.photo,tblemployees.FirstName,tblemployees.LastName,tblemployees.EmpId,tblemployees.id,tblleaves.LeaveType,tblleaves.PostingDate,tblleaves.Status from tblleaves join tblemployees on tblleaves.empid=tblemployees.id order by lid desc limit 7";
